...
import { AppStoreBadge, PlayStoreBadge } from '../UI/StoreBadges';
...
export const Navbar: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Mobile Overlay */}
      <div className={`fixed inset-0 z-[60] bg-black/95 backdrop-blur-xl flex flex-col items-center justify-center transition-opacity duration-300 ${isOpen ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}`}>
        <button
