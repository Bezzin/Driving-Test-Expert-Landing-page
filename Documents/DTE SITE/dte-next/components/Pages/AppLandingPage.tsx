...
import { APP_SCREENSHOTS, HOME_PATH, PLAY_STORE_URL, APP_STORE_URL, TESTIMONIALS, TRUST_STATS } from '@/lib/constants'
...
export const AppLandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#121212] pb-24 text-white selection:bg-[#FFD700]/30 selection:text-white md:pb-0">
      ...
      <section className="relative min-h-[100svh] overflow-hidden pt-36 md:pt-28" id="top">
          ...
          <div>
            <Reveal direction="up" duration={0.8}>
              <h1 className="font-brand text-4xl font-black leading-[1.02] tracking-tight text-white sm:text-5xl md:text-7xl">
                Pass Your Driving Test First Time and Skip the 6-Month &ldquo;Fail Loop&rdquo;.
              </h1>
            </Reveal>

            <Reveal delay={0.15}>
              <p className="mt-5 max-w-2xl text-base leading-relaxed text-white/75 md:text-xl">
                Don&apos;t get stuck in the 24-week backlog. Use the &ldquo;cheat code&rdquo; to practice every examiner route at your local centre so you pass first time and stay off the waiting list forever.
              </p>
            </Reveal>
            ...
            <Reveal delay={0.2}>
              <p className="mt-4 inline-flex items-center rounded-full border border-[#FFD700]/30 bg-[#FFD700]/10 px-4 py-1.5 text-xs font-bold text-[#FFD700] md:text-sm">
                Save £137+ in rebooking fees and &ldquo;holding&rdquo; lessons by passing on your first attempt.
              </p>
            </Reveal>
      ...
      <section id="about" className="relative z-10 px-6 pb-16">
        <div className="mx-auto max-w-7xl">
          <Reveal direction="up" delay={0.15}>
            <div className="mb-6">
              <h2 className="font-brand text-3xl font-black text-white md:text-5xl">See the &ldquo;Cheat Code&rdquo; in Action</h2>
          ...
          <Reveal direction="up" delay={0.2}>
            ...
            >
              ...
              <div className="mt-3 flex items-center justify-between gap-3 px-1">
                <p className="text-sm text-white/75">See the &ldquo;Cheat Code&rdquo; in Action</p>
            ...
            {TESTIMONIALS.slice(0, 2).map((item) => (
              <Reveal key={item.author} direction="up" delay={0.2}>
                <div className="rounded-2xl border border-white/10 bg-black/50 p-5 text-left">
                  ...
                  <p className="leading-relaxed text-white/90">&ldquo;{item.quote}&rdquo;</p>
