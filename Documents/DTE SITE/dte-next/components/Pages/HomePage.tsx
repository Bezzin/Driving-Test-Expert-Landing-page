...
import { ASSETS, APP_PATH, TESTIMONIALS, TRUST_STATS } from '@/lib/constants'
              ...
              <div className="space-y-6 text-lg text-white/80 leading-relaxed">
                ...
                <ul className="space-y-4 ml-4">
                  <li className="flex items-start gap-3">
                    <span className="text-accent mt-2">&bull;</span>
                    <div>
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {TESTIMONIALS.slice(0, 3).map((item) => (
              <div key={item.author} className="rounded-2xl border border-white/10 bg-black/50 p-6 md:p-7">
                ...
                <p className="text-white/90 leading-relaxed">&ldquo;{item.quote}&rdquo;</p>
