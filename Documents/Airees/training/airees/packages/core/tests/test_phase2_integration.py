...
async def test_full_phase2_loop_with_tools(store, tmp_path):
    ...
    # Call 5: Quality gate scores Worker 1
    score1_response = _make_text_response('{"score": 9, "feedback": "Good"}')

    # Call 6: Worker 2 (Summarize) -- no tools, just text
    worker2_response = _make_text_response("Summary: the topic is about X.")

    # Call 7: Quality gate scores Worker 2
    score2_response = _make_text_response('{"score": 9, "feedback": "Good"}')

    # Call 8: Brain evaluates
